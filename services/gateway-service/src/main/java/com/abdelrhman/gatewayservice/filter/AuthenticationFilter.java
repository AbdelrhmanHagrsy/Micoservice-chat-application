package com.abdelrhman.gatewayservice.filter;

import com.abdelrhman.gatewayservice.client.AuthClient;
import com.abdelrhman.gatewayservice.util.JwtUtil;
        ...
        return (((exchange, chain) -> {
            if(routeValidator.isScured.test(exchange.getRequest())){
                ...
                try {
                    ...
                    exchange.getRequest().mutate().header("X-User-Email",userEmail);
